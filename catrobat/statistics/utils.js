...
var webcomponentsUtils = {
    ...
    registerElement: function(tagName, registerCallbacks) {
        var callback = registerCallbacks();
        class HTMLElementWithRegisteredCallbacks extends HTMLElement {
            connectedCallback() {
                callback.call(this);
            }
        }
        customElements.define(tagName, HTMLElementWithRegisteredCallbacks);
    },
